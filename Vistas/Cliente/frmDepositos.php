  ...
  <div class="container text-justify">
    <div class="row contactos p-3">
      ...
      <div class="col-6">
        ...
        <!-- <div class="form-group">
            <label for="exampleFormControlTextarea1">Id Cliente</label>
            <input type="text" name="txtid" value="<?php echo $datoID; ?>" class="form-control">
          </div>
          <div class="form-group">
            <label for="exampleFormControlTextarea1">Nombre Cliente</label>
            <input type="text" name="txtnombre" value="<?php echo $datoNombre; ?>" class="form-control">
          </div> -->
          ...
          <div class="form-group">
            <label for="exampleFormControlTextarea1">Ingresa la cantidad a depositar</label>
            <input type="text" name="txtTotal" class="form-control" placeholder="Ingresa la cantidad a depositar" maxlength="6" onkeypress="return soloNumeros(event)">
          </div>
          <input type="submit" name="btnDepositar" value="Depositar" class="btn btn-outline-primary">
        </form>
      </div>
    </div>
  </div>
