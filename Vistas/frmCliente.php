    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link active" href="/prestamos/index?clase=controladorprivado&metodo=inicio">Inicio</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="/prestamos/index?clase=controladorcliente&metodo=AgregarAbono&op=1">Abono</a>
                </li>
            </ul>
